...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.comboBox.setGeometry(QtCore.QRect(60, 80, 211, 22))
        ...
        self.SerialEnter = QtWidgets.QPushButton(self.centralwidget)
        self.SerialEnter.setGeometry(QtCore.QRect(60, 110, 211, 23))
        self.SerialEnter.setObjectName("SerialEnter")
        ...
        self.comboBox_2.setGeometry(QtCore.QRect(320, 450, 69, 22))
        self.comboBox_2.setObjectName("comboBox_2")
        self.spinBox_3 = QtWidgets.QSpinBox(self.centralwidget)
        self.spinBox_3.setGeometry(QtCore.QRect(320, 480, 71, 22))
        self.spinBox_3.setObjectName("spinBox_3")
        self.serial_refresh = QtWidgets.QPushButton(self.centralwidget)
        self.serial_refresh.setGeometry(QtCore.QRect(190, 20, 81, 23))
        self.serial_refresh.setObjectName("serial_refresh")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.SerialEnter.setText(_translate("MainWindow", "Initializate"))
        ...
        self.serial_refresh.setText(_translate("MainWindow", "Refresh"))
        ...
        self.serial_refresh.clicked.connect(self.clickbutton_refresh)
        self.SerialEnter.clicked.connect(self.clickbutton_initializate)
    ...
    def clickbutton_refresh(self):
        ...
        for onePort in ports:
            ...
            self.comboBox.addItem(str(onePort))

    def clickbutton_initializate(self):

        serialInst = serial.Serial()
        _translate = QtCore.QCoreApplication.translate
        combobox_value = self.comboBox.currentText()
        combobox_baud = self.comboBox_baud.currentText()

        serialInst.baudrate = int(self.comboBox_baud.currentText())
        serialInst.port  = str(combobox_value[0:5])
        serialInst.open()

        #self.SerialEnter.setEnabled(False)
        print("A")
        ...
        while cont < 10:
            ...
            if serialInst.in_waiting:
                ...
                self.lineEdit.setText(_translate("MainWindow", packet.decode('utf')))
        ...
        #self.SerialEnter.setEnabled(True)
